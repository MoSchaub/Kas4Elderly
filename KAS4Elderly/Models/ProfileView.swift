...
struct ProfileView: View {
    ...
    var body: some View {
            ScrollView {
                VStack {
                    Image(uiImage: userData.user!.image ?? UIImage(named: "user")!)
                    ...
                    HStack {
                        Text("Name: \(userData.user!.name)").padding()
                        Spacer()
                        Button(action: {
                    ...
                    HStack {
                        Text("Alter: \(userData.user!.age)").padding()
                        Spacer()
                        Button(action: {
                            self.userData.editing = true
                    ...
                    HStack {
                        Text("E-mail: \(userData.user!.email)").padding()
                        Spacer()
                        Button(action: {
                            self.userData.editing = true
...
//wohnort change
                    Button("Passwort ändern"){
                        self.userData.resetPassword(for: self.userData.currUser()!.email)
                    }
